...
<body>
    ...
    <main role="main">
        ...
        <div class="jumbotron" style="position: relative">
            <div class="jumbotron-background" style="background-image: url('<?php echo $randBanner; ?>');"></div>
            <div class="container">
                    ...
                    <p>
                        <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <p class="card-text"> <?= number_format(rankingPopularity($shows)[0]['statistics']['popularity'],0,"."," ")?> personnes regardes cettes serie.</p>
                          </div>
                        </div>
                    </p>
                    <p>
                        <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <p class="card-text"><?= number_format(rankingPopularity($shows)[1]['statistics']['popularity'],0,"."," ")?> personnes regardes cettes serie.</p>
                          </div>
                        </div>
                    </p>
                    <p>
                        <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <p class="card-text"><?= number_format(rankingPopularity($shows)[2]['statistics']['popularity'],0,"."," ")?> personnes regardes cettes serie.</p>
                          </div>
                        </div>
                    </p>
                    <p>
                    ...
                    <p>
                        <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <p class="card-text"><i class="fa fa-star text-info"></i> <?= number_format(rankingRating($shows)[0]['statistics']['rating'],2,"."," ")?> / 5</p>
                          </div>
                        </div>
                    </p>
                    <p>
                        <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <p class="card-text"><i class="fa fa-star text-info"></i> <?= number_format(rankingRating($shows)[1]['statistics']['rating'],2,"."," ")?> / 5</p>
                          </div>
                        </div>
                    </p>
                    <p>
                        <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <p class="card-text"><i class="fa fa-star text-info"></i> <?= number_format(rankingRating($shows)[2]['statistics']['rating'],2,"."," ")?> / 5</p>
                          </div>
                        </div>
                    </p>
                    <p>
